...
Configuration adopts the following structure:
    ...
    # Usually 8-dim for single-arm datasets; bimanual encodings may be 14 or 16-dim.
    state_obs_keys:
        ...
        StateEncoding.JOINT_BIMANUAL_7DOF: 2 x [Joint Angles (7) + Gripper Open/Close (1)]
...
class StateEncoding(IntEnum):
    ...
    JOINT_BIMANUAL_7DOF = 5 # TRON2: 2 x [7 joint angles + gripper]
    # fmt: on
...
class ActionEncoding(IntEnum):
    ...
    JOINT_POS_BIMANUAL_ABSOLUTE = 5  # TRON2: 2 x [7 joint targets + gripper]
    # fmt: on
...
OXE_DATASET_CONFIGS = {
    ...
    "tron2_lerobot": {
        "image_obs_keys": {
            ...
            "secondary": "image_left_wrist",
            "wrist": "image_right_wrist",
        },
        "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None},
        "state_obs_keys": ["state"],
        "state_encoding": StateEncoding.JOINT_BIMANUAL_7DOF,
        "action_encoding": ActionEncoding.JOINT_POS_BIMANUAL_ABSOLUTE,
    },
    "metaworld_ml1_50e": {
        "image_obs_keys": {"primary": "image_primary", "secondary": None, "wrist": None},
        "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None},
